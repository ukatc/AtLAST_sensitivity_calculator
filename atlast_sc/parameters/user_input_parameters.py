...
class UserInputParameters:
    ...
    def derived_parameters(self):
        ...
        """
        # NOTE: Derived parameters object live in user input class because it is 
        # recalculated every time a user input is changed. With the refactored version 
        # of the software, it made more sense to keep the calculation of the derived 
        # parameters and the current state of the derived parameters within UIP. 
        # This is not the “best” solution per se, however, given the time constraints 
        # it's the best solution -that relatively makes sense- for now.
