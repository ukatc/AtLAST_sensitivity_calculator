...
.. uml::
    ...
    atlast_sc.efficiencies.Efficiencies --* atlast_sc.calculator.Calculator
    atlast_sc.temperatures.Temperatures --* atlast_sc.calculator.Calculator
    atlast_sc.atmosphere_params.AtmosphereParams --* atlast_sc.calculator.Calculator
