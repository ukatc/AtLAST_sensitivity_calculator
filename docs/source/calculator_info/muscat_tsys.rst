...
* :math:`\eta_\mathrm{chip}` is the pixel efficiency
* :math:`\eta_\mathrm{co}` is the cold optics optical efficiency due to the Lyot stop illumination
...
* :math:`\eta_\mathrm{chip} = 0.7`
* :math:`\eta_\mathrm{co} = 0.35` 
* :math:`\Delta_\mathrm{g} = 200\,\mu\mathrm{eV}` 
* :math:`\eta_\mathrm{pb} = 0.4`
* :math:`T_\mathrm{co} = 0.3\,\mathrm{K}`
