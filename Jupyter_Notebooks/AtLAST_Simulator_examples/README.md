...
The sensitivity calculator has a minimal set of required packages that it downloads
...
these packages, use either `pip install <package>` or `conda install <package>` in your
sensitivity calculator environment (if you downloaded the repo using pip or conda).
