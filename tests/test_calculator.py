...
def test_sensitivity():
    # TODO: These values should be re-calculated by hand to ensure tests are correct and robust.
    assert calculator.calculate_sensitivity(calculator.t_int).value == pytest.approx(0.0057, abs=0.00001)


def test_integration():
    # TODO: These values should be re-calculated by hand to ensure tests are correct and robust.
    assert calculator.calculate_t_integration(calculator.sensitivity).value == pytest.approx(0.32536, abs=0.0001)
